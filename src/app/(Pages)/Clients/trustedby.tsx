...
>
  <div className="bg-[#D9D9D9]/20 rounded-md shadow-lg flex items-center justify-center px-4 py-2">
    <h1 className="text-center text-base md:text-3xl font-grown text-indigo-900 leading-snug m-0">
